...
<body>
    <div class="container">
        <div class="row justify-content-center">
            <div class="col-lg-8">
                <div class="card p-4">
                    <h1 class="mb-4 text-center"><i class="fa fa-edit"></i> Edit Item</h1>
                    <form:form action="/editSaveToDoItem" method="post" modelAttribute="todo">
                        ...
                        <div class="text-center">
                            <button type="submit" class="btn btn-primary px-4"><i class="fa fa-save"></i> Save Changes</button>
                        </div>
                    </form:form>
    ...
    <script>
        window.onload = function() {
            var msg = "${message}";
            if (msg == "Edit Failure") {
                alert("Something went wrong with the edit.");
            }
        }
    </script>
</body>
